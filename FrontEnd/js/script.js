// Etape 3
// Reprise des éléments du swagger au format json
  let works = [
    {
      "id": 1,
...
// Boucle foreach pour parcourir les données du tableau works
  works.forEach(work => {
// Appel à la fonction pour chaque élément du tableau
